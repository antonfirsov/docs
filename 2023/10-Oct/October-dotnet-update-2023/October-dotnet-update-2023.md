---
post_title: .NET October 2023 Updates – .NET 7.0.13, .NET 6.0.24
...
* Installers and binaries: [7.0.13](https://dotnet.microsoft.com/download/dotnet/7.0) | [6.0.24](https://dotnet.microsoft.com/download/dotnet/6.0) 
* Release notes: [7.0.13](https://github.com/dotnet/core/blob/main/release-notes/7.0/7.0.13/7.0.13.md) | [6.0.24](https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.24/6.0.24.md)
* [Container images](https://mcr.microsoft.com/catalog?search=dotnet/)
* Linux packages: [7.0.13](https://github.com/dotnet/core/blob/main/release-notes/7.0/install-linux.md) | [6.0.24](https://github.com/dotnet/core/blob/main/release-notes/6.0/install-linux.md)
...
***12th Sept 2023 Security Updates***
...
***10th Oct 2023 Security Updates***
...
[efcore-6-0-23]: https://github.com/dotnet/efcore/issues?q=milestone%3A6.0.23+is%3Aclosed+label%3Aservicing-approved+
