...
Check out what's new in [C#](https://devblogs.microsoft.com/dotnet/check-out-csharp-12-preview), [ASP.NET Core](https://devblogs.microsoft.com/dotnet/asp-net-core-updates-in-dotnet-8-preview-3), [EF Core](https://devblogs.microsoft.com/dotnet/tag/entity-framework/), and [.NET MAUI](https://devblogs.microsoft.com/dotnet/announcing-dotnet-maui-in-dotnet-8-preview-3/) in the Preview 3 release. Stay current with [What's New in .NET 8](https://learn.microsoft.com/dotnet/core/whats-new/dotnet-8). [.NET Docs](https://learn.microsoft.com/dotnet/fundamentals/) will be updated throughout the release.
