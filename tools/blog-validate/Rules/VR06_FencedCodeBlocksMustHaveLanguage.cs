...
internal sealed class VR06_FencedCodeBlocksMustHaveLanguage : ValidationRule
{
    private static readonly HashSet<string> _languages = new (
        ...
        coffee,coffeescript,console,cpp,c#,cs,csharp,cshtml,cshtml-razor,cson,css,cts,cxx,diff,django,
        docker,dockerfile,dsconfig,f,fs,fsharp,gemspec,gql,graphql,h,h++,haml,hh,hpp,html,http,https,
