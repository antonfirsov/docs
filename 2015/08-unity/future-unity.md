...
A few months ago, we announced that we were [handing Prism over to new owners](http://blogs.msdn.com/b/dotnet/archive/2015/03/19/prism-grows-up.aspx). We put a lot of time and effort into identifying owners that would invest in the project and support the community.

Today, we are announcing a similar transition of ownership for [Unity](http://aka.ms/unity).
...
Be sure to read the [official announcement](https://weblogs.asp.net/cibrax/the-future-of-unity) from the new team and follow their work on the [new GitHub repo](https://github.com/unitycontainer/unity). Let them know what you'd like to see in future releases of Unity and help them continue to grow the community.
