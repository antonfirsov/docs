...
* **Trusted** - .NET libraries have developers' trust by publishing them to NuGet using security best practices.​
...
Please check out the [.NET Library Guidance](https://docs.microsoft.com/dotnet/standard/library-guidance/) and leave feedback in the [dotnet/docs repo](https://github.com/dotnet/docs/issues/new). We hope to see your fantastic .NET libraries on NuGet soon!