# Annoucing .NET Library Guidance

We've just published our first cut of the [.NET Library Guidance](https://docs.microsoft.com/en-us/dotnet/standard/library-guidance/). It's brand new documentation for .NET developers who want to create high-quality libraries for .NET. The guidance contains recommendations we have identified as common best practices that apply to most public .NET libraries.
...
Finally, the guidance is not complete. We want input from authors of .NET libraries to help improve and expand the documentation as .NET continues to grow and improve.

## Video

.NET Conf 2018 featured a video that demonstrates many of the same guidelines:

<iframe width="560" height="315" src="https://www.youtube.com/embed/hLFyycJVo0I" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

## Closing

Please check out the .NET Library Guidance [here](https://docs.microsoft.com/en-us/dotnet/standard/library-guidance/), and leave feedback in the [dotnet/docs repo](https://github.com/dotnet/docs/issues/new). We hope to see your fantastic .NET libraries on NuGet soon!