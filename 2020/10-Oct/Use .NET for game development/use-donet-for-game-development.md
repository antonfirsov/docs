...
.NET does not just cover building your game. You can also use it to build your game's website with [ASP.NET](https://dotnet.microsoft.com/apps/aspnet?WT.mc_id=gamedev-blog-abhamed), your mobile app using [Xamarin](https://dotnet.microsoft.com/apps/xamarin?WT.mc_id=gamedev-blog-abhamed), and even do remote rendering with [Microsoft Azure](https://azure.microsoft.com/solutions/gaming?WT.mc_id=gamedev-blog-abhamed). Your skills will transfer across the entire game development pipeline.
