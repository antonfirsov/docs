...
```html
<iframe src="https://channel9.msdn.com/Shows/On-NET/Porting-desktop-apps-to-NET-Core/player" width="960" height="540" allowFullScreen frameBorder="0"></iframe>
```

***[Video](https://youtu.be/tp1EOFtnTmA)***
