# Announcing ML.NET 1.1 and Model Builder updates for June 2019
...
Today we’re announcing **[ML.NET](https://dot.net/ml) 1.1** which includes updates for [ML.NET](https://dot.net/ml) 1.0 RTM and **Model Builder** ([released May 2019](https://devblogs.microsoft.com/dotnet/announcing-ml-net-1-0/)). 
