...
This means that ***installing the .NET Core Windows Forms designer from a separate VSIX is no longer needed!***

To use the designer:

- You must be using [Visual Studio](https://visualstudio.microsoft.com/vs/preview/ "Visual Studio Preview download") 16.5 Preview 1 or a later version.
