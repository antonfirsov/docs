 ...
 * System.Text.Json added support for serializing dictionaries (`IDictionary<TKey, TValue>`) in 3.0-preview5. Support for dictionaries with complex (non-primitive) values will be available in the next preview release.
