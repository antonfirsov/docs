 ...
 * Support for [OpenAPI / Swagger](https://docs.microsoft.com/en-us/aspnet/core/tutorials/web-api-help-pages-using-swagger?view=aspnetcore-2.2) when using System.Text.Json is ongoing and unlikely to be available as part of the 3.0 release.
 * System.Text.Json added support for serializing dictionaries (`IDictionary<TKey, TValue>`) in 3.0-preview5. Support for dictionaries with complex (non-primitive) values is will be available in the next preview release.
...
- Some of the types supported by Newtonsoft.Json are not supported by the new serializer. For example, `System.Guid`.
