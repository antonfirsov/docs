...
Today, we are announcing [.NET Core 2.0 Preview 2](https://www.microsoft.com/net/core/preview). We have made improvements that we want to share and that we would love to get your feedback on. You can develop .NET Core 2.0 apps with Visual Studio 2017 Preview 15.3, Visual Studio for Mac or VS Code.
...
- [.NET Core 2.0 Preview 2](https://github.com/dotnet/core/blob/master/release-notes/download-archives/2.0.0-preview2-download.md)
- [Visual Studio 2017 Preview 15.3 for Windows](https://www.visualstudio.com/vs/preview)
- [Visual Studio for Mac](https://www.visualstudio.com/vs/visual-studio-mac)
- [Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=ms-vscode.csharp)

You can see complete details of the release in the [.NET Core 2.0 Preview 2 release notes](https://github.com/dotnet/core/blob/master/release-notes/2.0/2.0.0-preview2.md). Known issues and workarounds are included in the releases notes. You can learn about previous improvements in the [.NET Core 2.0 Preview 1 blog post](https://blogs.msdn.microsoft.com/dotnet/2017/05/10/announcing-net-core-2-0-preview-1/).

To [everyone that helped with the release](https://github.com/dotnet/core/blob/master/release-notes/2.0/2.0.0-preview2-contributor.md), thank you very much. We couldn’t have gotten to this spot without you and we’ll continue to need your help as we work together towards the final .NET Core 2.0 release.
...
We have heard many requests for .NET Core 2.0 support with Azure App Service. [.NET Core 2.0 Preview 2 is being rolled out to App Service](https://github.com/Azure/app-service-announcements/issues/14) currently and we expect it to be completed by the end of the week. Some data centers may already be available.

### Docker images have moved to Debian Stretch

[.NET Core 2.0 Docker multi-arch tags](https://github.com/dotnet/announcements/issues/16) now use [Debian Stretch](https://www.debian.org/releases/stretch/) instead of [Debian Jessie](https://www.debian.org/releases/jessie/). .NET Core 2.0 Debian Jessie tags will still be provided. Debian Stretch is considered by the .NET Core team to be a better default choice for .NET Core Docker Linux image users for the lifetime of .NET Core 2.x.  There are no plans to update .NET Core 1.x in the same way.

### Added Support for SUSE Linux Enterprise Server

.NET Core 2 Preview 2 has added support for [SUSE Linux Enterprise Server (SLES)](https://www.suse.com/products/server/). Our support starts with SLES 12 SP2. We would appreciate feedback on our SLES support. We're also working with the folks at SUSE, so please do share with them that .NET Core support is important if that's the case for you.

### macOS High Sierra Support

We updated .NET Core for [issues found](https://github.com/dotnet/core/issues/677) on [macOS High Sierra](https://www.apple.com/macos/high-sierra-preview/). Please continue to report issues for the new macOS release.

## Improvements with .NET Core 2.0 Preview 2

The team spent the release polishing the .NET Core 2.0 release, both in terms of [quality improvements](https://github.com/dotnet/core/blob/master/release-notes/2.0/2.0.0-preview2-commit.md) and [performance](https://blogs.msdn.microsoft.com/dotnet/2017/06/07/performance-improvements-in-net-core/).
...
The file names for .NET Core installers has been updated according to [.NET Core 2+ Naming and Versioning](https://github.com/dotnet/designs/issues/2). You can see the updated file names at [.NET Core 2 Preview 2 Downloads](https://github.com/dotnet/core/blob/master/release-notes/download-archives/2.0.0-preview1-download.md).

## Closing

Please try out [.NET Core 2.0 Preview 2](https://github.com/dotnet/core/blob/master/release-notes/2.0/2.0.0-preview2.md). We are collecting feedback in the [dotnet/core #711](https://github.com/dotnet/core/issues/711) issue. We are continue to improve the .NET Core 2.0 release and are relying on feedback to direct our efforts.

We recently released [.NET Application Architecture Guidance](https://www.microsoft.com/net/learn/architecture). You can use these guides to get practical advice, best practices, and sample applications for using .NET with microservices, Docker containers, Kubernetes, Xamarin, ASP.NET, Azure, Service Fabric, and more.