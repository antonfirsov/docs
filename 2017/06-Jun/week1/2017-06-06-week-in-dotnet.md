---
title: The week in .NET - On .NET with Brett Morrison
...
* [Docker for .NET Developers Part 1: An introduction to Docker for .NET developers](https://www.stevejgordon.co.uk/docker-dotnet-developers-part-1), and [Part 2: Taking a look at our first dockerfile and building an image for an ASP.NET Core API service](https://www.stevejgordon.co.uk/docker-for-dotnet-developers-part-2) by Steve Gordon.
