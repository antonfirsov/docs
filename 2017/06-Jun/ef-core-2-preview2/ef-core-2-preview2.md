...
In general, it should be possible to use Preview 2 by installing a 2.0 Preview 2-compatible version of an EF Core data provider.
...
``` console
PM> update-package Microsoft.EntityFrameworkCore.Tools -Version 2.0.0-preview2-final
```
