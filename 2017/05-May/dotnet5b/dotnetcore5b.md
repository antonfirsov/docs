...
**[CVE-2017-0247](https://portal.msrc.microsoft.com/security-guidance/advisory/CVE-2017-0247)**
...
**[CVE-2017-0248](https://portal.msrc.microsoft.com/security-guidance/advisory/CVE-2017-0248)**
...
See the [release notes](https://github.com/dotnet/core/blob/master/release-notes/1.0/1.0.5.md) for a list of all fixes included in this release.

## Getting the Update

The .NET Core May 2017 Update is available from the [.NET Core download site](https://www.microsoft.com/net/download/core). CVE-2017-0248 effects a library which is not included in the Core download so developers can will need to update applications depend on System.Text.Encodings.Web by rebuilding with the new version available on NuGet.org.

### Docker Images

Updated images are available at [microsoft/dotnet](https://hub.docker.com/r/microsoft/dotnet/). Pulling the latest image will update you local Docker image cache.