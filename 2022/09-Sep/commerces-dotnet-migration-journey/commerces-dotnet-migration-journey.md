...
With our more complex services moving into Kubernetes, our migration required more than just .NET:
- Windows to Linux
...
There are several tools available to start you off (for example [Code Maps built into Visual Studio](https://docs.microsoft.com/visualstudio/modeling/map-dependencies-across-your-solutions)), and the [.NET release notes](https://github.com/dotnet/core/tree/main/release-notes) and [ASP.NET Core migration guides](https://learn.microsoft.com/aspnet/core/migration/) are a great place to get started on exploring what’s new and available to take advantage of.
