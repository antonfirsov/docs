---
post_title: .NET Conf Focus on MAUI - That's a wrap!
author1: jeffreytfritz@yahoo.com
post_slug: dotnet-conf-focus-on-maui-recap
username: jeffreytfritz@yahoo.com
microsoft_alias: jefritz
featured_image: hero.png
categories: .NET, .NET MAUI
summary: August 9th we hosted our .NET Conf Focus on MAUI event to announce and share the latest tools and updates for .NET MAUI.  With 25 sessions hosted and recorded, we recap the event and get you connected with all of the content from our event.
desired_publication_date: 2022-08-19
---
...
![.NET MAUI Roadmap](maui-focus-keynote-roadmap.png)

![.NET MAUI Schedule](maui-focus-keynote-schedule.png)
...
[![.NET MAUI point of sale demo app](dotnet-maui-pos-app.png)](https://github.com/dotnet/maui-samples/tree/main/6.0/Apps/PointOfSale)
