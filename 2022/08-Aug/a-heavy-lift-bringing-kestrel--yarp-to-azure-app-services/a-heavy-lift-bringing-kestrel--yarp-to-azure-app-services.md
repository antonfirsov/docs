---
post_title: 'A Heavy Lift: Bringing Kestrel + YARP to Azure App Services'
author1: byvinyal
post_slug: bringing-kestrel-and-yarp-to-azure-app-services
username: byvinyal
microsoft_alias: byvinyal
featured_image: FE_Diagram.jpg
categories: .NET, .NET Core, ASP.NET Core, Azure, Cloud, gRPC, Performance
summary: In this post, we get a behind-the-scenes look at the engineering work required to change a critical platform component with code paths that are exercised billions of times a day while minimizing service disruptions and maintaining SLA for our customers.
desired_publication_date: 2022-08-29
---
> **NOTE:** This blog was originally posted to the [App Service Team blog](https://azure.github.io/AppService/)
...
![FrontEndRole diagram](FE_Diagram.jpg)
...
![FrontEndRole Migration](FE_Migration.jpg)
