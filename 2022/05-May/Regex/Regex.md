---
post_title: Regular Expression Improvements in .NET 7
username: stoub@microsoft.com
microsoft_alias: stoub
categories: .NET, Performance
featured_image: AtomicLazyLoop.png
desired_publication_date: 2022-05-12
summary: System.Text.RegularExpressions has improved significantly in .NET 7. In this post, we'll deep-dive into many of its exciting improvements.
---

A friend once quipped to me that "computer science is entirely about sorting and searching", and while that's a gross overgeneralization, there's a grain of truth to it. Searching is, in one way, shape, or form, at the heart of many workloads, and it's so important that multiple domain-specific languages have been created over the years to ease the task of expressing searches. Arguably none is more ubiquitous than regular expressions.
...
![NFA for ".*?(?:abc|cd)"](abcOrcdDotStarNfa.png)
...
![DFA for ".*?(?:abc|cd)"](abcOrcdDotStarDfa.png)
...
- [Atomic groups](https://docs.microsoft.com/dotnet/standard/base-types/grouping-constructs-in-regular-expressions#atomic_groups)
- [Backreferences](https://docs.microsoft.com/dotnet/standard/base-types/backreference-constructs-in-regular-expressions)
- [Balancing groups](https://docs.microsoft.com/dotnet/standard/base-types/grouping-constructs-in-regular-expressions#balancing_group_definition)
- [Conditional](https://docs.microsoft.com/dotnet/standard/base-types/alternation-constructs-in-regular-expressions#Conditional_Expr)
- [Lookarounds](https://docs.microsoft.com/dotnet/standard/base-types/grouping-constructs-in-regular-expressions#zerowidth_positive_lookahead_assertion)
- [Start anchors (`\G`)](https://docs.microsoft.com/dotnet/standard/base-types/anchors-in-regular-expressions#contiguous-matches-g)
...
![Regex syntax colorization, validation, and IntelliSense in Visual Studio](RegexColorization.png)
...
![WebProxy colorization and IntelliSense in Visual Studio 2022](WebProxyColorization.png)
...
![Cached regex static field](CachedInstance.png)
...
![Debugging through source-generated Regex code](DebuggableSource.png)
...
![Generated XML comments describing regex](XmlComments.png)
...
![Unsupported regex still being cached](CachedInstance_Fallback.png)
...
![RegexGenerator analyzer and fixer](ConvertToRegexGenerator.png)
...
![Auto-atomic loops shown in XML comments](XmlCommentShowingAtomicLoop.png)
...
![Auto-reduced lazy loop matching empty](AtomicLazyLoop.png)
