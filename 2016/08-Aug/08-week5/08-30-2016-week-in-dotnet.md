...
To read last week's post, see [The week in .NET – 8/23/2016](https://blogs.msdn.microsoft.com/dotnet/2016/08/23/the-week-in-net-8232016/).

On .NET
-------

Last week, [Phillip Carter was on the show and gave some pretty neat intro-level F# demos](https://channel9.msdn.com/Shows/On-NET/Phillip-Carter-F):
...
The [F# Data](http://fsharp.github.io/FSharp.Data/) library takes full advantage of F# type providers to help you read data from various providers such as CSV, or remote JSON or XML APIs.

![Getting IntelliSense on data from a remote API](http://fsharp.github.io/FSharp.Data/images/start.png)

Tool of the week: NDepend
-------------------------

[NDepend](http://www.ndepend.com/) is one of the best ways to find architectural issues in a code base. It will identify problematic coupling and cycles in your dependency structure, and it will enable you to query code using LINQ queries.
...
The [Capital City .NET Users Group](http://www.meetup.com/tally-dot-net/) hosts an [intro to Azure DocumentDB for .NET and SQL Server developers](http://www.meetup.com/tally-dot-net/events/233070827/) on Thursday, September 1 at 6PM in Tallahassee with Santosh Hari.
...
* [Functional Programming with F# (YouTube playlist)](https://www.youtube.com/playlist?list=PLEoMzSkcN8oNiJ67Hd7oRGgD1d4YBxYGC) by David Wilson.
* [Mobius, Microsoft's Official Bindings to Apache Spark, has F# Samples now!](https://github.com/Microsoft/Mobius/tree/master/examples/fsharp)
* [F# for the Curly Brace Developer (video)](https://www.youtube.com/watch?v=4t95-S7GQe4) by Michael Newton.
* [Creating a Slack Bot with F# and Suave in Less than 5 Minutes](https://dusted.codes/creating-a-slack-bot-with-fsharp-and-suave-in-less-than-5-minutes) by Dustin Moris Gorski.
* [Getting Started with F# with Cross-Platform Tools](https://docs.microsoft.com/en-us/dotnet/articles/fsharp/tutorials/getting-started/getting-started-cross-platform-tooling) by Phillip Carter.
* [Transpiling F# to JavaScript with Fable](https://www.infoq.com/news/2016/08/fsharp-fable-javascript) by Pierre-Luc Maheu.
...
* [Xamarin Podcast: Identity Management in Mobile Apps](https://blog.xamarin.com/podcast-identity-management-in-mobile-apps/) by Pierce Boggan.
* [Creating a Serverless Backend for Mobile Apps](https://blog.xamarin.com/creating-a-serverless-backend-for-mobile-apps/) & [Continuous Integration for iOS Apps with Visual Studio Team Services](https://blog.xamarin.com/continuous-integration-for-ios-apps-with-visual-studio-team-services/) by James Montemagno.
* [How Olo Powers 150+ Restaurant Ordering Apps with Mobile DevOps](https://blog.xamarin.com/how-olo-powers-150-restaurant-loyalty-apps-with-mobile-devops/) by Lacey Butler.
* [NuGet Package Explorer for Xamarin Studio](http://lastexitcode.com/blog/2016/08/20/NuGetExplorerForXamarinStudio/) by Matt Ward.
* [Xamarin Beta Preview 2: Cycle 8](https://releases.xamarin.com/beta-preview-2-cycle-8/) by Adrian Murphy.
* [Cryptography in Portable Libraries](https://xamarinhelp.com/cryptography-in-xamarin-forms/) by Adam Pedley.
...
* [comment on this gist](https://gist.github.com/bleroy/b392c192438cfb81e6c8ec0a41d37cd1)
