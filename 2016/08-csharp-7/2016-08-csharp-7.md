...
What follows is a description of all the upcoming language features in C# 7.0. With the release of [Visual Studio "15" Preview 4](https://www.visualstudio.com/downloads/visual-studio-next-downloads-vs), most of the planned language features are coming alive. Now is a great time to take them for a spin and tell us your thoughts!
...
There are still a number of things not fully working in Preview 4. In the following I have described the features as they are *intended* to work when we release the final version, and called out in notes whenever things don't yet work as planned.
...
> **Note**: In Preview 4, the scope rules are more restrictive: Out variables 
