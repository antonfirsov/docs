...
If you have multiple services that you want to deploy as Guest Services you can simply edit this Guest Service Project file to include new Code, Config and Data packages for the new service or use the **ServiceFabricAppPackageUtil.exe** as mentioned in this [Deploy multiple guest executables](https://azure.microsoft.com/en-us/documentation/articles/service-fabric-deploy-multiple-apps/) tutorial. 
