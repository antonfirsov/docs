...
Today we are releasing a new Security and Quality Rollup and Security Only Rollup for the .NET Framework. You can read more about the recent changes to how the .NET Framework recieves updates on the [.NET Framework Monthly Rollups Explained](https://blogs.msdn.microsoft.com/dotnet/2016/10/11/net-framework-monthly-rollups-explained/) post. 
