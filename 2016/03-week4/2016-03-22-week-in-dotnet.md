...
On [Wednesday, March 23, the New York ALT.NET group is holding an IoT for Windows 10 presentation with Becky Isserman](http://www.meetup.com/nyaltnet/events/221401654/).
...
* [Building Reactive Services Using Functional Programming](https://www.youtube.com/watch?v=lK-VhOOjxN8), by Rachel Reese.
* [.NET Machine Learning: F# and Accord.NET](http://www.infoq.com/presentations/accord-net-machine-learning), by Alena Hall.
* [Functional Reactive Programming with NUI](https://www.youtube.com/watch?v=AU2LT18SFP8), by Riccardo Terrell.
* [GPUs and DSLs for Life Insurance Modeling](https://devblogs.nvidia.com/parallelforall/gpus-dsls-life-insurance-modeling/), by Peter Sestoft.
* [Earthquake Scraping with a Type Provider](https://cogitoergofun.ghost.io/earthquake-scrapping-with-a-type-provider/), by Edgar Sánchez.
* [Functional Architecture is Ports and Adapters](http://blog.ploeh.dk/2016/03/18/functional-architecture-is-ports-and-adapters/), by Mark Seemann.
...
* [comment on this gist](https://gist.github.com/bleroy/5853a1e7a79f3393ac69)
