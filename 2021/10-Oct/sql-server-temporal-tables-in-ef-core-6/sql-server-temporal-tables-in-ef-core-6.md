...
featured_image: temporal.jpg
categories: .NET Core, Entity Framework, ASP.NET, SQL Server
...
[Watch the EF Core Community Standup for Temporal Tables](https://youtu.be/2aCgKM41NFw)
...
> __💡NOTE:__
> See the [SQL Server temporal tables documentation](https://docs.microsoft.com/sql/relational-databases/tables/temporal-tables#how-do-i-query-temporal-data) for more information on exactly which rows are included for each of these operators.
...
_Special thanks to [Arthur Vickers](https://twitter.com/ajcvickers) who contributed to this blog post._
